...
from sqlalchemy import ForeignKey, Integer, DateTime, TypeDecorator, TEXT, UniqueConstraint
...
class EmbeddedProfile(Base):
    ...
    profile: Mapped["UserProfile"] = relationship(back_populates="emb_profile", uselist=False)
    __table_args__ = (
        UniqueConstraint("pid", name="embedded_profile_pid_key"),
    )